...
import reportingCardData from "../../data/reportingCardData.json";
  ...
  return (
    <div className="w-full h-full analytics-container overflow-visible md:p-[0px] px-[14px]">
      <div className="analytics-sub flex flex-col gap-[1rem] h-full justify-between items-center">
        ...
        <motion.div 
          className="analytics-title w-full flex items-center justify-center flex-col gap-[12px] text-center"
          initial={{ opacity: 0, y: 20 }} 
          whileInView={{ opacity: 1, y: 0 }} 
          transition={{ duration: 1, ease: "easeOut" }}
          viewport={{ once: true, amount: 0.2 }}
        >
          <FancyTitle title="Reporting" />
          ...
          <p className="text-[16px] font-normal leading-[1.4] text-[#9ca3af] mt-0 mb-[10px] text-center md:w-[40%]">
            Gain deep insights into your trading performance with detailed reports. Track your progress over time, identify strengths and weaknesses, and make data-driven decisions to enhance your strategy.
          </p>
        </motion.div>
