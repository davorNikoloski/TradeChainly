        ...
        <div className="w-full h-full flex justify-between items-center flex-col md:flex-row gap-[32px]">
            <div className="cta-content flex flex-col items-center justify-center md:gap-[28px] gap-[2px]">
              <div className='md:space-y-[28px] pt-[24px] pb-[12px] md:p-[0px] flex items-center flex-col'>
                <h1 
                  className={`text-center font-mulish text-white text-[27px] md:text-[40px] leading-tight md:leading-[3rem] transition-opacity duration-700 md:pb-[0px] pb-[2px] ${isTextVisible ? 'opacity-100' : 'opacity-0'}`}
                >
                    Elevate Your Trading Journey With Us
                </h1>
                <p 
                  className={`text-center font-inter text-[#9e9e9e] text-sm font-normal mt-0 mb-2 md:leading-6 leading-tight max-w-[80%] transition-opacity duration-700 ${isTextVisible ? 'opacity-100' : 'opacity-0'}`}
                >
