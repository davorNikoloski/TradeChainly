...
export default async function PrivacyPolicy() {
  // Dynamically import the privacy policy data
  const privacyPolicyData = (await import("../../data/privacyPolicyData.json")).default;

  return (
    <div className="privacyPolicy mt-[2rem] pb-[0px] mx-auto w-full h-auto bg-opacity-0 flex items-center justify-center overflow-visible relative z-1">
