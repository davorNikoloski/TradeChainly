...
export default async function Home() {
  const featuresData = (await import("../data/featuresData.json")).default;
  const benefitsData = (await import("../data/benefitsData.json")).default;
  const communityData = (await import("../data/communityData.json")).default;
